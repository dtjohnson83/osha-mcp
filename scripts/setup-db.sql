-- ============================================
-- OSHA MCP Server Database Schema
...
CREATE POLICY "anon_insert" ON penalty_schedule FOR INSERT WITH CHECK (true);
CREATE POLICY "anon_insert" ON ppe_mappings FOR INSERT WITH CHECK (true);
CREATE POLICY "anon_insert" ON naics_standards FOR INSERT WITH CHECK (true);
